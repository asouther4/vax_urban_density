...
configs_list = []    
number_of_runs = 5 #define the number of replications to run each configuration
discount_list = [(i/10) for i in range(11)]

for discount_factor in discount_list:
